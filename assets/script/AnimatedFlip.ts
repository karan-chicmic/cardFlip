import { _decorator, Component, EventMouse, instantiate, Label, Node, Prefab, randomRangeInt, tween, Vec3 } from "cc";
import { addImage } from "./addImage";
const { ccclass, property } = _decorator;

@ccclass("AnimatedFlip")
export class AnimatedFlip extends Component {
